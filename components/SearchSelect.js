...
function SearchSelect({platform,setPlatform}) {
  ...
  return ( //Esto es la botonera de select de la pagina de search. Las condiciones es para cotrolar cual esta en activo y cual no.
    <div className={styles.container}>
      ...
      <button className={`jus-center al-center ${platform == "uno"?styles.buttonSearchActive:styles.buttonSearchDesactive}`} onClick={() => setPlatform("uno")}><Image alt='CodIcon' width={27} height={27} src='/img/unowt.png'></Image></button>
    </div>
  )
}
